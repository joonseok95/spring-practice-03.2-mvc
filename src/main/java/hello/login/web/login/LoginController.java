...
public class LoginController {
    ...
    @PostMapping("/login")
    public String login4(@Validated @ModelAttribute LoginForm form, BindingResult bindingResult, HttpServletRequest request, @RequestParam(defaultValue = "/") String redirectURL) {
